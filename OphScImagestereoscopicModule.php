...
class OphScImagestereoscopicModule extends BaseEventTypeModule
{
	...
	public function init() {
		...
		$this->setImport(array(
			'OphScImagestereoscopic.models.*',
			'OphScImagestereoscopic.components.*',
		));
		
		$this->moduleShortSuffix = "imagestereoscopic";
	}
