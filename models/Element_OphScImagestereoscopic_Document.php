...
/**
 * This is the model class for table "et_ophscimagestereoscopic_document".
 *
...
class Element_OphScImagestereoscopic_Document extends ElementScannedDocument
{
	public $service;
	...
	{
		return 'et_ophscimagestereoscopic_document';
	}
